...
class ProfileController extends Controller
{
    ...
    public function change_name(Request $request)
    {
        ...
        $request->session()->flash('success', 'You have successfully changed your name.');
        return back();
    }
    public function change_lastname(Request $request)
    {
        $request->validate([
            'lastname' => ['required', 'string', 'max:255'],
        ]);
        ...
        $request->session()->flash('success', 'You have successfully changed your lastname.');
        return back();
    }
